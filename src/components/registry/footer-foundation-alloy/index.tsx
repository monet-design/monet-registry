...
const IMAGES = {
  // 예시:
  // hero: {
  //   path: "/registry/footer-foundation-alloy/hero.jpg",
...
interface FooterFoundationAlloyProps {
  mode?: "light" | "dark";
  // TODO: Define additional props
}

export default function FooterFoundationAlloy({
  mode = "light",
  ...props
}: FooterFoundationAlloyProps) {
  const colors = COLORS[mode];

  return (
    <section className="relative min-h-screen w-full bg-white dark:bg-gray-950">
      {/* TODO: Implement footer-foundation-alloy component */}
      {/* 색상 사용 예시: */}
