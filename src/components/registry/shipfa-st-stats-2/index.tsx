...
const CONTENT = {
  stats: [
    { hours: "4 hrs", task: "to set up emails", prefix: "" },
    { hours: "6 hrs", task: "designing a landing page", prefix: "+" },
    { hours: "4 hrs", task: "to handle Stripe webhooks", prefix: "+" },
    { hours: "2 hrs", task: "for SEO tags", prefix: "+" },
    { hours: "1 hr", task: "applying for Google Oauth", prefix: "+" },
    { hours: "3 hrs", task: "for DNS records", prefix: "+" },
    { hours: "2 hrs", task: "for protected API routes", prefix: "+" },
    { hours: "∞ hrs", task: "overthinking...", prefix: "+" },
  ],
  total: {
    hours: "22+ hours",
    text: "of headaches",
  },
  cta: "There's an easier way",
} as const;
...
interface ShipfaStStats2Props {
  mode?: "light" | "dark";
}

// Headache/cloud with rain icon - full SVG from original
const HeadacheIcon = ({ className }: { className?: string }) => (
  <svg
    className={className}
    viewBox="0 0 154 150"
    fill="currentColor"
...
export default function ShipfaStStats2({ mode = "dark" }: ShipfaStStats2Props) {
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative rounded-lg p-8 md:p-16 max-w-lg mx-auto text-center text-lg"
      ...
      >
        <div className="leading-relaxed space-y-4 md:space-y-6">
          ...
          <motion.div
            ...
            className="text-xl font-semibold flex flex-col md:flex-row items-center justify-center gap-3 text-white"
          >
            <p>
              ={" "}
              <span className="font-medium" style={{ color: colors.accent }}>
            ...
            <HeadacheIcon className="w-8 h-8 fill-neutral-200 shrink-0" />
          </motion.div>
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="absolute bottom-8 inset-x-0 text-center flex gap-1 justify-center items-center text-sm"
