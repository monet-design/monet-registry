...
function TweetCard({
  ...
  return (
    <motion.div
      ...
      className={`cursor-grab rounded-xl border border-gray-200 bg-white p-4 shadow-[0_2px_8px_rgba(0,0,0,0.08)] active:cursor-grabbing ${className}`}
      style={{ maxWidth: 300, rotate: rotation }}
    >
  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#F9F8F3] px-4 py-16 md:px-8 md:py-24">
      ...
      <div className="relative mx-auto hidden max-w-6xl lg:block" style={{ height: 700 }}>
        ...
        <div className="absolute right-[10%] top-[460px]">
