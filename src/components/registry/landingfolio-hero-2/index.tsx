    ...
    <section className="w-full bg-[#FEFDFB] min-h-screen overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 pt-12 md:pt-16 pb-16">
        <div className="flex flex-col md:flex-row gap-12 md:gap-8 items-start">
          {/* Left Content */}
          <div className="max-w-xl md:w-[42%] md:flex-shrink-0">
            {/* Tagline */}
            <motion.p
            ...
            <motion.h1
              ...
              className="text-5xl sm:text-6xl md:text-[4rem] font-medium text-black mb-6 leading-[1.1] tracking-tight whitespace-pre-line"
          ...
          <div className="relative h-[500px] md:h-[550px] md:flex-1 w-full">
            {/* Yellow Circle - Person 1 (top left) */}
            <motion.div
              initial={{ opacity: 0, scale: 0.8 }}
              animate={{ opacity: 1, scale: 1 }}
              transition={{ duration: 0.6, delay: 0.3 }}
              className="absolute top-8 left-0 w-28 h-28 md:w-36 md:h-36 rounded-full overflow-hidden bg-[#FACC16]"
            >
              <Image
                src={images.person1 || ""}
                alt="Professional"
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.4 }}
              className="absolute top-0 left-24 md:left-28 w-32 md:w-40 bg-black rounded-3xl p-4 md:p-5"
            >
              <p className="text-white text-xs md:text-sm mb-0.5">Active</p>
              <p className="text-white text-xs md:text-sm mb-2">Professionals</p>
            ...
            <motion.div
              ...
              className="absolute -top-2 left-40 md:left-48 w-4 h-4 md:w-5 md:h-5 rounded-full border-2 border-gray-300"
            />
            ...
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1 }}
              transition={{ duration: 0.6, delay: 0.5 }}
              className="absolute -top-4 right-0 w-28 h-28 md:w-36 md:h-36 rounded-full overflow-hidden bg-[#E0BAFB]"
            >
              <Image
                src={images.person2 || ""}
                alt="Professional"
            ...
            <motion.div
              ...
              className="absolute top-28 md:top-32 left-0 w-40 h-48 md:w-52 md:h-60 rounded-[2rem] overflow-hidden bg-[#2563EB]"
            >
              <Image
                src={images.person3 || ""}
                alt="Professional"
            ...
            <motion.div
              ...
              className="absolute top-40 md:top-48 left-44 md:left-56"
            >
              <SparkleIcon className="w-12 h-12 md:w-16 md:h-16 text-black" />
            </motion.div>
            ...
            <motion.div
              ...
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.5, delay: 0.6 }}
              className="absolute top-28 md:top-36 right-0 w-20 h-36 md:w-24 md:h-44 rounded-l-full bg-[#FACC16]"
            />
            ...
            <motion.div
              ...
              className="absolute bottom-4 md:bottom-8 left-20 md:left-28 w-32 md:w-40 bg-[#CEF7DC] rounded-3xl p-4 md:p-5"
            >
              <p className="text-black text-xs md:text-sm mb-0.5">Online</p>
              <p className="text-black text-xs md:text-sm mb-2">Courses</p>
            ...
            <motion.div
              ...
              className="absolute bottom-12 md:bottom-16 right-8 md:right-12 w-14 h-14 md:w-16 md:h-16 rounded-full bg-[#EF4444]"
            />
            ...
            <motion.div
              ...
              className="absolute bottom-0 md:bottom-4 right-20 md:right-28"
            >
              <CursorIcon className="w-5 h-5 md:w-6 md:h-6 text-gray-400" />
            </motion.div>
          </div>
        </div>
      </div>
