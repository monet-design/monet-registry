...
export default function LandingfolioHero10({
  ...
  headline = "Collaborate remotely, with",
  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden bg-[#EFF5F3]">
      ...
      <motion.nav
        ...
        className="relative z-20 flex items-center justify-between px-6 py-5 lg:px-16"
      >
        {/* Logo */}
        ...
        <div className="hidden items-center gap-4 md:flex">
          ...
          <a
            href="#signup"
            className="rounded-md border border-[#1a1a1a] bg-transparent px-4 py-2 text-sm font-medium text-[#1a1a1a] transition-all hover:bg-[#1a1a1a] hover:text-white"
          >
            Try for free
          </a>
        </div>
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 gap-8 px-6 py-12 lg:grid-cols-2 lg:gap-12 lg:px-16 lg:py-16">
        ...
        >
          <h1 className="text-4xl font-bold leading-tight tracking-tight text-[#1a1a1a] sm:text-5xl lg:text-[3.5rem] lg:leading-[1.15]">
            {headline.split("\n").map((line, i) => (
              <span key={i}>
                {line}
                {i < headline.split("\n").length - 1 && <br />}
            ...
            <span className="relative inline-block">
              ...
              <span
                className="absolute bottom-1 left-0 -z-0 h-4 w-full"
                style={{
        ...
        >
          <div className="relative h-[400px] w-full max-w-[500px] lg:h-[480px]">
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5, delay: 0.4 }}
              className="absolute left-[5%] top-[12%] z-10 w-[70%] rounded-lg bg-[#E5EBE9] p-4 shadow-sm"
            >
              {/* Lines representing content */}
              <div className="space-y-2">
                <div className="h-2 w-3/4 rounded bg-[#D1D9D6]" />
                <div className="h-2 w-1/2 rounded bg-[#D1D9D6]" />
                <div className="h-2 w-2/3 rounded bg-[#D1D9D6]" />
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="absolute left-[10%] top-[28%] z-30 max-w-[200px] rounded-lg bg-[#1a1a1a] px-4 py-3 text-xs text-white shadow-lg"
            >
            ...
            <motion.div
              ...
              className="absolute right-0 top-[38%] z-10 w-[55%] rounded-lg bg-[#E5EBE9] p-4 shadow-sm"
            >
              <div className="space-y-2">
                <div className="h-2 w-full rounded bg-[#D1D9D6]" />
                <div className="h-2 w-3/4 rounded bg-[#D1D9D6]" />
                <div className="h-2 w-full rounded bg-[#D1D9D6]" />
                <div className="h-2 w-1/2 rounded bg-[#D1D9D6]" />
              </div>
