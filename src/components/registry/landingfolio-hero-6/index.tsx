...
export default function LandingfolioHero6({
  ...
  return (
    <section className="relative min-h-screen w-full bg-[#F9FAFC]">
      ...
      {/* Main Content */}
      <div className="relative mx-auto max-w-7xl px-6 pt-12 pb-16 sm:px-8 lg:pt-16">
        {/* Center Content */}
        <div className="flex flex-col items-center text-center">
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl lg:text-[56px] font-bold text-gray-900 leading-[1.15] whitespace-pre-line tracking-tight"
          >
            {headline}
          </motion.h1>
          ...
          <motion.p
            ...
            className="mt-5 text-base text-gray-500 max-w-md whitespace-pre-line leading-relaxed"
          >
            {subheadline}
          </motion.p>
      ...
      <div className="relative w-full h-[380px] overflow-visible hidden md:block">
        {/* Left Testimonial Card - Martin Gray */}
        <TestimonialFloatingCard
          ...
          className="absolute left-[1%] top-[40%]"
          delay={0.5}
        />
        ...
        >
          <div className="w-[150px] h-[200px] rounded-2xl overflow-hidden shadow-xl">
            <Image
              src={personImage}
        ...
        {/* Floating Person Card - Man */}
        <PersonFloatingCard
          imageSrc={floatingPersonImage}
          className="absolute right-[30%] top-[-8%]"
          delay={0.5}
        />
        ...
        <StatFloatingCard
          number={stats.number}
          label={stats.label}
          className="absolute right-[20%] top-[18%] w-[110px]"
          delay={0.6}
        />

        {/* Right Testimonial Card - Floyd Miles */}
        <TestimonialFloatingCard
      ...
      <div className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-[#F9FAFC] to-transparent pointer-events-none" />
    </section>
  );
}
